...
The library to turtle can be found [[file:../src/Racket/turtle/turtle-graphics.rkt][here]].
It's written in Racket.
Though not the finest example of my coding skills, it does allow me to tak the code examples from the book without much conversion.
