...
#+BIBLIOGRAPHY: ../bib/references acm limit:nil
...
#+HTML:        var disqus_identifier = 'http://www.peter-samarin.de/2014/06/29/perceptron-convergence-algorithm/';
#+HTML:        var disqus_url = 'http://www.peter-samarin.de/2014/06/29/perceptron-convergence-algorithm/';
